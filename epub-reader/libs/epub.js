	...
	_createClass(Stage, [{
		...
		value: function size(width, height) {
			...
			if (!width) {
				...
				width = _windowBounds.width - 30 ;
				console.log("Reader width:"+width);
			}
			if (this.settings.fullsize || !height) {
				height = _windowBounds.height;
				console.log("Windows height:"+height);
				height = Math.min(_windowBounds.height - 100, 440);
				console.log("Reader height:"+height);
			}
